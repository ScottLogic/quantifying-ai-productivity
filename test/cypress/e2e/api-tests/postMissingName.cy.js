...
describe('Create Task with Missing Name Test', () => {
    it('should create a task with a missing description and return status code 400', () => {
      ...
      const createEndpointUrl = 'http://localhost:8080/todo/addTask?name=Missing Name';
      ...
      cy.request({
        ...
        expect(response.body).to.have.property('path','/todo/addTask?name=Missing%20Name');
      });
    });
  });
